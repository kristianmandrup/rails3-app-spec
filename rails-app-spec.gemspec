...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rails3_artifactor>, ["~> 0.2.2"])
      s.add_runtime_dependency(%q<sugar-high>, ["~> 0.2.8"])
      s.add_runtime_dependency(%q<code-spec>, ["~> 0.2.3"])
      s.add_runtime_dependency(%q<file-spec>, ["~> 0.1.1"])
    else
      s.add_dependency(%q<rspec>, ["~> 2.0.0.beta.22"])
      s.add_dependency(%q<require_all>, ["~> 1.1.0"])
      s.add_dependency(%q<rails3_artifactor>, ["~> 0.2.2"])
      s.add_dependency(%q<sugar-high>, ["~> 0.2.8"])
      s.add_dependency(%q<code-spec>, ["~> 0.2.3"])
